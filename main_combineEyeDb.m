...
%              end
%          end
         z.resp{iDb,iExp}=eyeX.resp{iDb,iExp}+1i*eyeY.resp{iDb,iExp};
         dmovement_angle.resp{iDb,iExp}=angle(dz.resp{iDb,iExp});
         movement_angle.resp{iDb,iExp}=angle(z.resp{iDb,iExp});
         movement.resp{iDb,iExp}=abs(z.resp{iDb,iExp});
         dmovement.resp{iDb,iExp}=abs(dz.resp{iDb,iExp});
        
         velocity.resp{iDb,iExp}=cat(4,diff(movement.resp{iDb,iExp},1,4),zeros(1,13,n_trial,1));
